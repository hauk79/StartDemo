 ...
 */
public class HelpScreen2 extends hyu.hauk.snake.assets.AbstractAssetsManagedScreen {
    private static final String NAME = HelpScreen2.class.getSimpleName();
    ...
    public void showManaged() {
        ...
        help = new Sprite(Assets.INSTANCE.getTexture(Assets.HELP2));
